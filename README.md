...
| ERC725XCore.sol                                       | 194  | Core implementation logic of the ERC725X sub-standard, a generic executor contract.                                                                                                                  | `@openzeppelin/contracts`: [`Create2.sol`, `Address.sol`, `BytesLib.sol`]                                                                                                                                     |
